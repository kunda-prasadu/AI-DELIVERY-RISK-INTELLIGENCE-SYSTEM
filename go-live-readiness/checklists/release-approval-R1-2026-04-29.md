...
- Hypercare SLA output (`go-live-readiness` `npm run check:hypercare`): PASS (captured in latest hypercare SLA evidence)
...
- [x] `npm run check:hypercare` passed (local hypercare SLA evidence)
