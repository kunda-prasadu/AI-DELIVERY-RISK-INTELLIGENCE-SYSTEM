...
cd "$ROOT_DIR"
docker compose up -d --build identity-service project-service observability-service metrics-normalization-service api-gateway-service
...
echo ""
echo "Compose backend stack is ready."
